...
const FASTENER_REALISM = `Use varied but mechanically authentic industrial screws and bolts. Valid types include external hex-head bolts, socket-head cap screws with a centered hexagonal recess, Torx screws with a centered six-lobe recess, Phillips cross-head screws, slotted screws, countersunk screws, button-head screws and flange bolts. Every round screw head must show a crisp, centered and physically plausible drive recess; a smooth featureless round metal top is a plug, boss or dowel and must never be presented as a screw. External hex bolts must have a clear six-sided outline. Keep each fastener straight, correctly scaled and seated flush against a machined surface or washer, with a small realistic contact shadow and visible threads only where physically exposed. Do not fuse screws into the casting and do not create floating, melted or decorative fasteners.`;
