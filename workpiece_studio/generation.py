...
DEFAULT_NEGATIVE_PROMPT = (
    ...
    "screw-covered workpiece, more than two installed screws, upside-down screw, inverted screw, vertical standing screw, "
    ...
    "grid, more than five small holes on the top face, clustered screws, adjacent screw "
...
FASTENER_REALISM_PROMPT = (
    ...
    "screws: approximately 3 to 5 mechanically plausible drilled or threaded holes, "
    ...
    "or grids of holes and never exceed 5 small holes on the top face. "
    "and a sparse, non-dense arrangement of approximately 1 to 2 clearly visible "
    ...
    "workpiece, with the head facing upward and the shaft hidden inside the hole. Use at "
    "most one screw per hole and keep every screw separated from all other screws. Never "
    "stack, overlap, fuse, or place one screw on top of another. Never place a screw beside "
    "a hole, upside down, vertically standing, floating, or partially "
