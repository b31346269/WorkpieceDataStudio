...
DEFAULT_NEGATIVE_PROMPT = (
    ...
    "empty threaded holes used instead of screws, one installed screw, three or more "
    "installed screws, more than two installed screws, "
    "screw-covered workpiece, dense fastener pattern, headless threaded stud, protruding "
...
FASTENER_REALISM_PROMPT = (
    ...
    "and exactly 2 clearly visible screws, seated in separate mounting positions. "
    "Treat this as a strict counting constraint: the entire workpiece must contain "
    "two screw heads total, no more and no fewer. Never "
