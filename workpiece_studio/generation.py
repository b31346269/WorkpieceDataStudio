...
DEFAULT_NEGATIVE_PROMPT = (
    ...
    "empty threaded holes used instead of screws, more than three installed screws, "
...
FASTENER_REALISM_PROMPT = (
    ...
    "and only 1 to 3 clearly visible screws, preferably exactly 2, seated in separate "
    "mounting positions. Never exceed 3 installed screws in one image. Never "
